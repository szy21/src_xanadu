...
namelist /radiation_driver_nml/ do_radiation, &
                                ...
                                do_conserve_energy, &
                                add_regional_sw_heating, &
                                sw_heating_magnitude, &
                                sw_heating_level, &
                                sw_heating_region  ! 071720[ZS]
!---------------------------------------------------------------------
!---- public data ----
...
real, allocatable, dimension(:,:,:)  :: global_sw_heating ! 071820[ZS]
...
!----------------------------------------------------------------------
      if (do_sw_rad) then
        ...
        call shortwave_driver (press, pflux, temp, rh2o, deltaz, &
                               ...
                               flag_stoch, Rad_control, &
                               Aerosolrad_control%do_swaerosol, Sw_output, local_sw_heating) ! 071820[ZS]
